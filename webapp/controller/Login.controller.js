sap.ui.define([
    ...
    return Controller.extend("com.apptech.bfi-businessunit.controller.Login", {
        ...
        fGetAllRecords: function(queryTag){
			// var aReturnResult = [];
			$.ajax({
				url: "https://xsjsv10.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=PROD_BIOTECH&procName=spAppBusinessUnit&QUERYTAG="+ queryTag +"&value1=&value2=&value3=&value4=",
				type: "GET",
				dataType: "json",
