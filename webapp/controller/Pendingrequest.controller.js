sap.ui.define([
  ...
  return Controller.extend("com.apptech.bfi-businessunit.controller.Pendingrequest", {
    ...
    fgetAllTransaction: function (transtypefilter) {
      ...
      var aReturnResult = [];
      $.ajax({
        url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&QUERYTAG=getAllPendingRequest&VALUE1="+ value1 +"&VALUE2="+ this.sUserCode +"&VALUE3&VALUE4=",
        type: "GET",
        async: false,
        datatype:"json",
    ...
    gGetBusinessUnit: function(){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getBusinessUnit&value1="+this.sUserCode+"&value2&value3&value4",
				type: "GET",
				datatype:"json",
				beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
