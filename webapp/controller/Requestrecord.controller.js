...
"sap/ui/model/FilterOperator"
  ...
  return Controller.extend("com.apptech.bfi-businessunit.controller.Requestrecord", {
    ...
    fgetAllTransaction: function (transtypefilter,oTransTatus) {
      ...
      var aReturnResult = [];
      $.ajax({
        url: "https://18.141.110.57:4300/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&QUERYTAG=getAllFilteredRequest&VALUE1="+ value1 +"&VALUE2="+ value2 +"&VALUE3=&VALUE4=",
        type: "GET",
        async: false,
        datatype:"json",
