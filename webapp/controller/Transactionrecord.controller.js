sap.ui.define([
	...
	"sap/ui/model/FilterOperator"
  	...
  	return Controller.extend("com.apptech.bfi-businessunit.controller.Transactionrecord", {
		...
		onInit: function () {
			...
			//GET ALL WAREHOUSE
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getallwarehouses&value1&value2&value3&value4",
				type: "GET",
				datatype:"json",
		...
		fgetAllTransaction: function (transtypefilter,oTransTatus) {
			...
			var urltag = "";
			if (value1 ===""){
				urltag ="https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&QUERYTAG=getFilteredTransactions&VALUE1=1&VALUE2=0&VALUE3=&VALUE4=";// getTransactions
			}else{
				urltag ="https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&QUERYTAG=getFilteredTransactions&VALUE1="+ value1 +"&VALUE2="+ value2 +"&VALUE3=&VALUE4=";
			}
			$.ajax({
				url: urltag,
				type: "GET",
		...
		f_configValueHelpDialogs: function (TransType,customertype) {
			...
			if (this.oMdlAllBP.getData().allbp.length <= 0) {
				...
				//GET ALL BP
				$.ajax({
					url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getallbp&value1="+ customertype +"&value2&value3&value4",
					type: "GET",
					datatype:"json",
				beforeSend: function(xhr){
					xhr.setRequestHeader("Authorization","Basic " + btoa("SYSTEM:Qwerty0987"));
    ...
    /// Record Posting
		...
		fUpdatePending: function (transtype,transno,oCardCode,oPostingDate,oMarkupType,oIssueBU,oReceiveBU,oRemarks,ostatus,oDocType,oDetails,oAttachment,oAttachmentKey) {
			...
			$.ajax({
			url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName=" + this.sDataBase + "&procName=spAppBusinessUnit&queryTag=deleteDraftDetails&value1=" +
		...
		gGetARAccounts: function(){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getARInvoiceAccount&value1&value2&value3&value4",
				type: "GET",
				datatype:"json",
				beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
		...
		gGetAPAccounts: function(){
			$.ajax({
				url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getAPInvoiceAccount&value1&value2&value3&value4",
				type: "GET",
				datatype:"json",
				beforeSend: function (xhr) {
					xhr.setRequestHeader("Authorization", "Basic " + btoa("SYSTEM:Qwerty0987"));
	...
	//GET ALL UOM
	$.ajax({
		url: "https://xsjs.biotechfarms.net/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBusinessUnit&queryTag=getalluom&value1="+ v1 +"&value2&value3&value4",
		type: "GET",
		datatype:"json",
	beforeSend: function(xhr){
		xhr.setRequestHeader("Authorization","Basic " + btoa("SYSTEM:Qwerty0987"));
